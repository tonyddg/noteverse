import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c as i,b as n,d as s,a as o,e as a}from"./app-e92d147b.js";const c={},r=a(`<h1 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack" aria-hidden="true">#</a> WebPack</h1><ul><li>在 node.js 中开发前端, 通过 WebPack 打包生成前端应用</li><li>Webpack 使用 loader 可以通过 import 导入任何资源</li></ul><h2 id="创建项目" tabindex="-1"><a class="header-anchor" href="#创建项目" aria-hidden="true">#</a> 创建项目</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> init <span class="token parameter variable">-y</span> <span class="token comment"># 使用 -y 参数, 使用默认设置</span>
